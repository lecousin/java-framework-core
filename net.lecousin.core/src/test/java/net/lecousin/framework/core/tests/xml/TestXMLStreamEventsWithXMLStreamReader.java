...
public abstract class TestXMLStreamEventsWithXMLStreamReader<EVENTS extends XMLStreamEvents> extends LCCoreAbstractTest {
	...
	public TestXMLStreamEventsWithXMLStreamReader(String filepath) {
	...
	private void check(javax.xml.stream.XMLStreamReader reader, EVENTS xml, LinkedList<String> openElements) throws Exception {
		/*
