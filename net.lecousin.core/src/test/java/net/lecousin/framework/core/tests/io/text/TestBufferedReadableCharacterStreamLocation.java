...
public class TestBufferedReadableCharacterStreamLocation extends TestCharacterStreamReadable {
	...
	public TestBufferedReadableCharacterStreamLocation(File testFile, byte[] testBuf, int nbBuf) {
