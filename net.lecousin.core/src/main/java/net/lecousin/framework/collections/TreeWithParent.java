...
public class TreeWithParent<T> {
	...
	/** Constructor with parent which can be null for the root node. */
	...
	public static class Node<T> {
		...
		public TreeWithParent<T> getSubNodes() { return subNodes; }
	}
	
	private TreeWithParent<T> parent;
	private ArrayList<Node<T>> nodes = new ArrayList<>();
	
	public TreeWithParent<T> getParent() { return parent; }
